...
export const works: WorksType = {
  ...
  projects: [
    ...
    },
    {
      ...
      skills: ['前端 RWD'],
      description:
        '利用 TDX API 整合景點資料，讓使用者可以在平台查詢縣市政府舉辦的近期活動及景點導覽。<br>此專案為參加<a class="cursor-target" href="https://2021.thef2e.com/" target="_blank">「THE F2E 3rd 前端修煉精神時光屋」</a>之比賽作品',
    ...
    },
    {
      ...
      imgs: ['/assets/works/fam_preregister.png'],
      link: 'https://deltaforce.garena.com/en/?redirect=0',
    },
    {
      id: 7,
      name: '手遊 In-App-Webview 網頁',
      category: WorksCategoryEnum.WORK,
      date: '2022~2025年',
      skills: [
        '前端 RWD',
      ...
      description:
        '開發和維護手遊內 In-App-Webview 的網頁，包含各式活動營收遊戲、遊戲活動大廳、賽事活動、玩家問卷。',
